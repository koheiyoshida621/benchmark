...
const int OPT_N = 400000000;
//  const unsigned int OPT_N = 400000000;
//  const unsigned long OPT_N = 800000000;
//                              2147483647
...
const unsigned long          OPT_SZ = OPT_N * sizeof(float);
...
for(int itr=0;itr<ITER;itr++){
    ...
    {
        getTime("Kernel:: BlackScholesGPU start");
	...
	cudaDeviceSynchronize();
        getTime("Kernel:: BlackScholesGPU end");
